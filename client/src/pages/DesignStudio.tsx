...
type Candidate = { id: number; name: string; colorHex: string; colorName: string; category: string; description: string | null; imageUrl: string | null };
